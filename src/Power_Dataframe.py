...
import pandas as pd
import numpy as np
import os,sys,re,itertools,pickle,ast,time,torch,copy
...
class Power_Dataframe():
    ...
    def plot(self, dataset, mb_size, opt_fun, optimizer_params, network_fun, loss_fun, ignore_optimizer_params=['params'], 
        ...
        dictionary_of_input_variables_related_to_plotting:{
            ...
            legend_position='center right', # Position of the legend (e.g. 'upper left', 'lower right', 'center right', ...)
            TITLE=True,                     # If True, it will add a title to the plot (or you can set it to a string to set a custom title)
        }
        '''
